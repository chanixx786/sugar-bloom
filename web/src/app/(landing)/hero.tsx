...
export default function Hero() {
  return (
    <section id="hero" className="relative min-h-screen overflow-hidden ">
      <div className="max-w-7xl mx-auto lg:px-12 lg:py-32 grid lg:grid-cols-2 items-center">
        <section className="flex flex-col justify-center items-start w-full ">
          ...
          <div className="flex flex-row gap-18 mt-16 shadow-right-md text-4xl items-bottom justify-start">
        ...
        <section className="lg:absolute lg:right-50 lg:top-2/5 lg:-translate-y-1/2 w-full lg:w-[45%] flex justify-end relative isolate">
          <div
            aria-hidden
