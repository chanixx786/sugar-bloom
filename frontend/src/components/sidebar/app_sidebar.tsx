...
function NavItem({
  ...
  return (
    ...
    <SidebarMenuItem className={cn("list-none", collapsed && "flex justify-center")}>
      <Link
        href={href}
        onClick={onClick}
...
export function AppSidebar() {
  ...
  return (
    <Sidebar collapsible="icon" className="border-r border-border ">
      {/* ── Logo header ── */}
      <SidebarHeader className={cn("px-4 py-4 transition-all duration-200", isCollapsed && "px-0")}>
        <div className={cn("flex items-center gap-0", isCollapsed && "justify-center")}>
          <Image
            src={sbImage}
            alt="Sugar Bloom icon"
            className={cn(
              "object-contain select-none shrink-0 transition-all duration-200",
